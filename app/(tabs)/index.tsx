...
import { CameraView, Camera, CameraCapturedPicture, useCameraPermissions } from 'expo-camera';
    ...
    <View style={styles.container}>
      <CameraView style={styles.camera} type={cameraType} ref={(ref: any) => setCameraRef(ref)}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.button} onPress={() => setCameraType(cameraType === Camera.Constants.Type.back ? Camera.Constants.Type.front : Camera.Constants.Type.back)}>
